...
After launching the program, the program will open the main GUI interface, and here are the instructions for using it.

#### <font color=red> in macOS/Linux/Windows </font>


(1) Click File->'Open Gene 1' to edit to open the gene sequence.
...
(4) Click File->'Save optimized gene' to save the optimized gene.
...
(5) Click File->'Export table to txt' to save the treeview list.
...
(6) Click File->'Export changed codons' to save the updated rows in the treeview list.
...
(7) Click File->'Import Gene 2 to compare' and compare the two gene sequences.
...
(8) Click Edit->'set graph X axis' to modify the font size and interval of the X axis
